    ...
    <form onSubmit={save} className="space-y-6">
      ...
      <section className="panel p-5 sm:p-6">
        ...
        <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
          ...
          <Button type="button" variant="outline" className="rounded-xl border-white/10 bg-white/[.04]" onClick={() => action("register")} disabled={!!busy}><Bot size={16} /> 3. Publish /seerr + /seerr4k</Button>
        </div>
      </section>
